  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark monkey-max-width">
    ...
    <div class="collapse navbar-collapse justify-content-start ml-md-auto " id="navbarNavAltMarkup">
      <div class="navbar-nav row">
        ...
        <a class="nav-item nav-link horizontal-line" href="/upload">이미지 업로드</a>
        <!--<a class="nav-item nav-link" aria-disabled="true" style="padding: 0px;">|</a>-->
        <a class="nav-item nav-link horizontal-line" href="#" id="sub2_Tab">인증</a>
        <a class="nav-item nav-link horizontal-line" href="#" id="sub3_Tab">베스트 계획</a>
        <a class="nav-item nav-link horizontal-line" href="#" id="board">월간 계획</a>
        <a class="nav-item nav-link horizontal-line" href="#" id="parallax">플랜더 모임</a>
      </div>
    </div>
